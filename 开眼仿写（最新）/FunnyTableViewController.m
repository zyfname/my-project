...
#import "smallcell.h"
#import "shopcell.h"
@interface FunnyTableViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UITableViewDelegate,UITableViewDataSource>
...
-(void)loadnewdata{
    ...
    [self.manager  GET:@"http://baobab.wandoujia.com/api/v1/videos.bak?strategy=date&categoryName=%E6%90%9E%E7%AC%91&num=30" parameters:nil success:^(NSURLSessionDataTask *task, id responseObject) {
