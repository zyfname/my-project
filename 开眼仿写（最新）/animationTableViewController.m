...
#import "smallcell.h"
#import "shopcell.h"
@interface animationTableViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UITableViewDelegate,UITableViewDataSource>
...
-(void)loadnewdata{
    ...
    [self.manager  GET:@"http://baobab.wandoujia.com/api/v1/videos.bak?strategy=date&categoryName=%E5%8A%A8%E7%94%BB&num=30" parameters:nil success:^(NSURLSessionDataTask *task, id responseObject) {
