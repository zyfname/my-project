...
#import "smallcell.h"
#import "shopcell.h"
@interface musicTableViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UITableViewDelegate,UITableViewDataSource>
...
-(void)loadnewdata{
    ...
    [self.manager  GET:@"http://baobab.wandoujia.com/api/v1/videos.bak?strategy=date&categoryName=%E9%9F%B3%E4%B9%90&num=30" parameters:nil success:^(NSURLSessionDataTask *task, id responseObject) {
