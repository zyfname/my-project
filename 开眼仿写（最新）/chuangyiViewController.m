...
#import "smallcell.h"
#import "shopcell.h"
@interface chuangyiViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UITableViewDelegate,UITableViewDataSource>
...
@implementation chuangyiViewController
...
-(void)loadnewdata{
    ...
    [self.manager  GET:@"http://baobab.wandoujia.com/api/v1/videos.bak?strategy=date&categoryName=%E5%88%9B%E6%84%8F&num=30" parameters:nil success:^(NSURLSessionDataTask *task, id responseObject) {
